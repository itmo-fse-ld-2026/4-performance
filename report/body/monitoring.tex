...
Мониторинг разработанных MBean и виртуальной машины Java выполнялся с использованием утилиты JConsole.

\subsubsection{Подключение к процессу}

На рисунке \ref{fig:jconsole-1} представлен общий вид вкладки \texttt{MBeans} с зарегистрированными MBean.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{screenshots/jconsole-1.png}
    \caption{Вкладка MBeans в JConsole.}
...
\begin{figure}[H]
    ...
    \caption{Атрибуты MBean PointCounter.}
...
\begin{figure}[H]
    ...
    \caption{Атрибуты MBean MissPercentage.}
...
\begin{figure}[H]
    ...
    \caption{Уведомления MBean PointCounter.}
