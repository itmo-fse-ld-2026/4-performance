 ...
 * {@link RequestScoped} и создаётся для каждого HTTP-запроса.</p>
 *
 ...
 * (например, от -6 до 6), что соответствует видимой области графика.</p>
 *
...
public class PointValidationBean {
     ...
     * (обычно от -6 до 6 по обеим осям).</p>
     *
