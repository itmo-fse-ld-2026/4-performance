 ...
 * к уникальному идентификатору текущей HTTP-сессии.</p>
 *
 * <p>Используется для привязки результатов проверки точек к конкретному
 * пользователю и для фильтрации истории по сессии.</p>
 *
...
public class SessionBean implements Serializable {
     ...
     * её уникальный идентификатор.</p>
     *
     * <p>Идентификатор сессии используется в {@link HistoryBean}
     * для фильтрации результатов проверок по конкретному пользователю.</p>
     *
