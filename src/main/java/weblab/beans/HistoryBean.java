 ...
 * но при этом поддерживается фильтрация по сессии для получения результатов конкретного пользователя.
 *
...
public class HistoryBean {
     ...
     * Для удаления только текущей сессии используйте {@link #removeResultsBySession(String)}.
     */
     ...
     * выполняется полная очистка всех результатов через {@link #clearResults()}.
     */
     ...
     * В противном случае возвращаются все результаты (например, при тестировании).
     *
