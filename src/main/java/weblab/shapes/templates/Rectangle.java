 ...
 * шириной {@code width} по оси X и высотой {@code height} по оси Y.</p>
 *
 ...
 * Границы прямоугольника считаются попаданием.</p>
 *
 * <p>Используется в комбинации с {@link QuadrantShape} для размещения
 * в других квадрантах (например, в квадранте 2, где x отрицательный).</p>
 *
